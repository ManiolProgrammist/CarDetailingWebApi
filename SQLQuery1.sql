...
Insert Into Orders
(UserId,CreateOrderUserId,OrderTemplateId,OrderDate,Cost,IsOrderCompleted,IsOrderStarted)
Values(2,2,3,GETDATE(),100,0,0);
Insert Into Orders
(UserId,CreateOrderUserId,OrderTemplateId,OrderDate,Cost,IsOrderCompleted,IsOrderStarted)
Values(3,1,2,GETDATE(),100,0,0);
Insert Into Orders
(UserId,CreateOrderUserId,OrderTemplateId,OrderDate,Cost,IsOrderCompleted,IsOrderStarted)
Values(2,1,1,GETDATE(),100,0,0);
